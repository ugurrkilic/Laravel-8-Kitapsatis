...
class ShopcartController extends Controller
{
    ...
    public function store(Request $request,$id)
    {
        ...
        $data->save();
        return redirect()->route('user_shopcart')->with('success', 'Product Added to Shopcart');
    }

    /**
     * Display the specified resource.
     *
     * @param  \App\Models\Shopcart  $sho)pcart
     * @return \Illuminate\Http\Response
     */
    ...
    public function update(Request $request, Shopcart $shopcart,$id)
    {
        ...
        $data->quantity= $request->input('quantity');
        $data->save();
        return redirect()->back()->with('success','Product Updated from Shopcart');
    }
